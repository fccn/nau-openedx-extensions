...
from nau_openedx_extensions.course_enrollment_allowed_guard import connect_course_enrollment_allowed_nif_guard
...
connect_course_enrollment_allowed_nif_guard()
