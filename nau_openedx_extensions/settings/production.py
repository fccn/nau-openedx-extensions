...
def plugin_settings(settings):
    ...
    settings.NAU_CERTIFICATES_MODULE = getattr(settings, "ENV_TOKENS", {}).get(
        "NAU_CERTIFICATES_MODULE", settings.NAU_CERTIFICATES_MODULE
    )
    settings.NAU_UTIL_MODULE = getattr(settings, "ENV_TOKENS", {}).get(
        "NAU_UTIL_MODULE", settings.NAU_UTIL_MODULE
    )
    settings.NAU_INSTRUCTOR_TASK_MODULE = getattr(settings, "ENV_TOKENS", {}).get(
        "NAU_INSTRUCTOR_TASK_MODULE", settings.NAU_INSTRUCTOR_TASK_MODULE
    )
